...
def clean_pointing04(pointing04_dir, destination_dir, detector, out_size, grayscale = False, interpolation = cv2.INTER_LINEAR, start_count = 0, duplicate_until = 0):
    '''
    ...
    Arguments:
        ...
        detector: Model used for detecting human heads in pictures.
    ...
    for i in range(1, 16):
        ...
        for img in images:
            ...
            bboxes = get_head_bboxes(pic, detector)
...
def main():
    ...
    clean_pointing04(pointing04_dir, destination_dir, detector, out_size, grayscale_output, downscaling_interpolation)
